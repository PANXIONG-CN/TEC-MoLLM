...
def train_one_epoch(model, dataloader, optimizer, loss_fn, device, edge_index, scaler, rank=0, accumulation_steps=1):
    ...
    for i, batch in enumerate(progress_bar):
        ...
        # REASON: bfloat16 offers better numerical stability than float16 due to its
        #         wider dynamic range, reducing the risk of overflow/underflow
        #         while maintaining performance benefits on modern GPUs.
